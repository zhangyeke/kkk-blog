          ...
          if (Array.isArray(item.children)) {
            return (
              <NavigationMenuItem key={i}>
                <NavigationMenuTrigger
                  className={"hover:text-primary data-[state=open]:text-primary data-[state=open]:bg-white"}
                >
                  {item.name}
                </NavigationMenuTrigger>
                <NavigationMenuContent>
                  {item.children.map((menu, index) => (
                    <NavigationMenuLink key={index + `${i}`} asChild>
                      <Link className={"text-nowrap"} href={menu.href || ""}>
                        {menu.name}
                      </Link>
                    </NavigationMenuLink>
                  ))}
          ...
          return (
            <NavigationMenuItem key={i}>
              <NavigationMenuLink asChild>
                <Link href={item.href || ""} className={"hover:text-primary flex-center"}>
                  {item.name}
                </Link>
              </NavigationMenuLink>
            </NavigationMenuItem>
